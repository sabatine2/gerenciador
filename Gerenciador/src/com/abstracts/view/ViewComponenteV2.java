...
public abstract class ViewComponenteV2 extends VerticalSplitPanel {
	/**
	 * 
	 */
	...
	private CssLayout buildHorizontalLayoutRight() {
		...
		// buttonExtra
		buttonExtra = new Button();
		buttonExtra.setCaption("Clonar");
		buttonExtra.addStyleName("border-normal");
		buttonExtra.setWidth("-1px");
		buttonExtra.setHeight("-1px");
		buttonExtra.setVisible(false);
		right.addComponent(buttonExtra);
		//buttonDeletar
    ...
    public abstract void remover(Object objeto);
