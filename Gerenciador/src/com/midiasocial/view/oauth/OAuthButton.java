...
public abstract class OAuthButton {
    ...
    protected void authenticate() {
        if (handler == null) {
            ...
            b.getWindow().addParameterHandler(handler);
        }
        b.getWindow().open(new ExternalResource(getAuthUrl()));
    }
     ...
     *  
     *  
     *  parameter handler that will be invoked when the user returns
        ...
        return new ParameterHandler() {
            public void handleParameters(Map<String, String[]> parameters) {
                if (parameters.containsKey(getVerifierName())) {
                    ...
                    b.getWindow().removeParameterHandler(handler);
                    handler = null;
                    b.getWindow()
                            .open(new ExternalResource(b.getWindow().getURL()));
